 ...
 * JhankiesPage
 * -------------
 * Video grid for all Jhanki performances. Driven by JHANKIES_MEDIA in
 * data/media.js - add a filename to that array (matching what's in the
 * R2 "jhankies/" folder) and a player appears here automatically.
    ...
    <section className="pt-32 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          <span className="text-maroon-700 uppercase tracking-widest text-xs font-bold">Live Performances</span>
          <h1 className="text-4xl md:text-5xl font-serif text-slate-800 mt-4">Jhankies</h1>
          <p className="text-slate-500 max-w-2xl mx-auto mt-4">
            Devotional Jhanki performances from our events
          </p>
        </div>

        {JHANKIES_MEDIA.length > 0 ? (
          ...
          <p className="text-slate-400 text-center">No Jhanki videos added yet.</p>
        )}
      </div>
    </section>
  );
